...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1708469203ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sales_management_system&table=sales_teams">`sales_management_system`.`sales_teams`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sales_management_system&table=personal_access_tokens">`sales_management_system`.`personal_access_tokens`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sales_management_system&table=password_resets">`sales_management_system`.`password_resets`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sales_management_system&table=migrations">`sales_management_system`.`migrations`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sales_management_system&table=failed_jobs">`sales_management_system`.`failed_jobs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sales_management_system&table=users">`sales_management_system`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=money_manager&table=users">`money_manager`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=money_manager&table=personal_access_tokens">`money_manager`.`personal_access_tokens`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=money_manager&table=failed_jobs">`money_manager`.`failed_jobs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=money_manager&table=bank_aaccounts">`money_manager`.`bank_aaccounts`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7b7b264c4d444756713a23387636334c">
...
<div id="topmenucontainer" class="menucontainer">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="sales_management_system" targettable="sales_teams">
            ...
            Database
                            : <span>sales_management_system</span>
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `sales_teams`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="sales_management_system" targettable="sales_teams">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `sales_teams`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="sales_management_system" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="sales_management_system" targettable="failed_jobs">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `failed_jobs`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="sales_management_system" targettable="migrations">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `migrations`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="sales_management_system" targettable="password_resets">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `password_resets`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="sales_management_system" targettable="personal_access_tokens">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
